...
public class Monitors {
	...
	public static void updateWeatherData_(Context context) {
		try {
	...
	public static void updateWeatherData(Context context) {
	    WeatherData.city = "Xiamen";
	    WeatherData.tempHigh = "High 15C";
	    WeatherData.tempLow = "Low 9C";
	    WeatherData.condition = "Cloudy";
	    WeatherData.temp = "13C";
	    WeatherData.icon = "weather_cloudy.bmp";
	    WeatherData.received = true;
